...
user_id, user_name, user_join, join_msg, last_action, user_language, user_timezone, user_status, user_color, user_font, user_rank, user_roomid, user_sound, session_id, pcount, prim_plus, fancy_name, sp_bg, sp_bg_width,
...
if($get_data->num_rows > 0){
	...
	require("../../../system/language/{$data['user_language']}/language.php");
