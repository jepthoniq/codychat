...
?>
<div <?php if (loadAddonName('chat_store')) {
			echo setProfileShadows($data);
		} ?>>
	...
	<?php } ?>
	<div class="modal_menu <?php if (loadAddonName('chat_store')) {
								echo $data['pro_color'];
							} ?>">
		<ul>
	...
	<div id="meditprofile" <?php if (loadAddonName('chat_store')) {
								echo setProfileColors($data);
							} ?>>
